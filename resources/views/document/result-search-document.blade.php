                    ...
                    @cell('action', $docs)
                        <div class="flex flex-row">
                            <div class="basis-1/2 text-center">
                                <Link slideover href="{{ route('documents.show', $docs->id) }}" title="Editar">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <div class="basis-1/2 text-center">
                                <Link slideover href="{{ route('documents.files', $docs->id) }}" title="Files">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <div class="basis-1/2 text-center">
                                <Link modal href="{{ route('documents.delete', $docs->id) }}" title="Delete">
