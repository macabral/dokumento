                    ...
                    @cell('action', $docs)
                        <div class="flex flex-row">
                            <div class="basis-1/2 text-center">
                                <Link slideover href="{{ route('documents.show', base64_encode($docs->id . 'spasw')) }}" title="Editar">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <div class="basis-1/2 text-center">
                                <Link slideover href="{{ route('documents.files', base64_encode($docs->id . 'spasw')) }}" title="Files">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <div class="basis-1/2 text-center">
                                <Link modal href="{{ route('documents.delete',  base64_encode($docs->id . 'spasw')) }}" title="Delete">
